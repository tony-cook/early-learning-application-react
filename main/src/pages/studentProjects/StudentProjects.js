...
// Variable declared from a window prompt on pageload and stored in localStorage(line 137) to query the user information from the backend
    ...
    const studentId = localStorage.getItem('userIdStudent')
    const profileRoute = '/StudentProfile'
...
// concatenated string of entire fetch API query declared as a single variable
    ...
    }, [studentId,state,courseLevel,showResults])
